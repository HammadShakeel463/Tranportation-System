...
//	student = fopen("studentdata.txt","a");
	...
	scanf("%lld",&ptr->phone);
//	fprintf(student , " NAME :  %s \n GENDER :  %s \n FATHER NAME :  %s  \n ADDRESS :  %s \n CELL NUMBER :  %lld \n",ptr->name , ptr->gender , ptr->fname , ptr->address , ptr->phone);
  //  fclose(student);
}
...
//	staff = fopen("staffdata.txt","a");
	...
	printf("Enter your cell number   :  ");
	scanf("%lld",&ptr->phone);
//	fprintf(staff , " NAME :  %s \n GENDER :  %s  \n ADDRESS :  %s \n CELL NUMBER :  %lld \n",ptr->name , ptr->gender , ptr->address , ptr->phone);
//	fclose(staff);
}
...
void route1()
{
	...
	printf("\n    ROUTE 1  \n 1. Malir Flyover  2. Qaidabad        3. Malir Morr         4. Airport           5. Shah Faisal Colony  6. PHAST NUCES \n");
...
void route2()
{
	...
	printf("\n    ROUTE 2   \n 1. Bharia Town   2. Highway         3. Gulshan e Hadid    4. Steel Town        5. Port Qasim          6. PHAST NUCES \n ");
...
void route4()
{
	...
	printf("\n     ROUTE 4     \n 1. Ziauddin   2. Bilawal House   3. Zamzama            4. Phase 8           5. Gizri               6. PHAST NUCES \n");
...
void route5()
{
	...
	printf("\n     ROUTE 5     \n 1. Korangi    2. Garden          3. Sindhi Muslim      4. Baloch Pull       5. PAF FAISAL          6. PHAST NUCES \n");
...
void route6()
{
	...
	printf("\n     ROUTE 6     \n 1. Dolman     2. Clifton         3. Defense            4. Boat Basin        5. Teen Talwaar        6. PHAST NUCES \n");
...
void route8()
{
	...
	printf("\n    Route 8   \n 1. Samama		   2. Continental    3. Johar Chorongi     4. Johar Morr        5. Malir Halt          6. PHAST NUCES  \n");
...
void route9()
{
	...
	printf("\n     Route 9   \n 1. Ayesha		   2. Gulhsan        3. Askari 4           4. COD               5. Drigh Road          6. PHAST NUCES \n");
	
}
void route10()
{
	
	printf("\n     ROUTE 10   \n 1. Teen Hati	   2. Dakhana        3. Ayeesha Manzil     4. Mukka Chauk       5. 13 D                6. PHAST NUCES \n");
...
void route11()
{
	...
	printf("\n     Route 11   \n 1. 4K Stop 	   2. Power House    3. U.P Morr           4. Nagan             5. Water Pump          6. PHAST NUCES \n");
...
void route12()
{
	...
	printf("\n     ROUTE 12  \n 1. Ajmair Nagri   2. Bara Dari     3. Anda Mor           4. Gulberg           5. Ancholi             6. PHAST NUCES \n");
...
//		
//		student = fopen("studentdata.txt" , "a");
//		fprintf(student , " ROUTE  :  %d \n\n",choice);
//		fclose(student);
//		
//	}else{
//		staff = fopen("staffdata.txt" , "a");
//		fprintf(staff , " ROUTE  :  %d \n\n",choice);
//		fclose(staff);
//	}
	return choice ;
}
...
int south(int s_opt)
{
	...
	{ 
		...
		printf("sorry beta ye fast hai app galat jagah aa gye ");
	}
...
int west(int s_opt)
{
	...
	else                                                   // if all the buses are full
	{
		...
		printf(" Sorry but all the buses are full "); 
	}
		...
		if(opt == 1 ){
			...
			//	char singleline[200];
				while(!feof(staff))
				{
					c = fgetc(staff);
					printf("%c",c);
			//		fgets(singleline, 200, staff);
			//		puts(singleline);
				}
				fclose(staff);
			}else if(fopt == 3 ){
				//char singleline[200];
				//char singleline2[200];
				student = fopen("studentdata.txt" , "r");
				staff = fopen("staffdata.txt" , "r");
				printf("\t\tStudent Data\n\n");
				student = fopen("studentdata.txt","r");
				...
				int c, d;
       			...
       			system("cls");
						...
						int abc;
						printf("want to delete 1.yes 2.no\n");
	                    scanf("%d", &abc);
                    	if(abc==1){
	                	one();
			}
